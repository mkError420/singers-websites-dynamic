...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($artist) || empty($file_path)) {
        ...
        if (insertData('songs', $song_data)) {
            header('Location: songs.php?added=1');
            exit();
        } else {
        ...
        <main class="admin-content">
            ...
            <form method="POST" enctype="multipart/form-data" class="song-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="genre" name="genre" class="form-control" placeholder="e.g., Pop, Rock, Jazz">
                </div>
                
                <div class="form-group">
                    <label for="duration">Duration</label>
                    <input type="text" id="duration" name="duration" class="form-control" placeholder="e.g., 3:45">
                </div>
