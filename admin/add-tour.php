...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($event_name) || empty($venue) || empty($city) || empty($country) || empty($event_date)) {
        ...
        if (insertData('tour_dates', $tour_data)) {
            header('Location: tour.php?added=1');
            exit();
        } else {
            $error = 'Failed to add tour date. Please try again.';
        }
    }
}
?>
...
<head>
    ...
    <title>Add Tour Date - Admin</title>
            ...
            <form method="POST" class="tour-form">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-save"></i> Add Tour Date
                    </button>
